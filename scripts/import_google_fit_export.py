#!/usr/bin/env python3
"""Import Google Fit Takeout export into HealthDataStore JSONL records."""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Import Google Fit data from a Google Takeout ZIP file"
    )
    parser.add_argument("export_zip", help="Path to Google Takeout ZIP file")
    ...
    # Markdown output
    print("# Google Fit Import Summary\n")
